...
The [`carryctx-skills`](https://github.com/Xuepoo/carryctx-skills) repository ships 32 presets out of the box, grouped under `presets/personas/`, `presets/rules/`, and `presets/workflows/`:
...
**Personas** (8): `architect`, `commander`, `devops-engineer`, `performance-engineer`, `qa-engineer`, `reviewer`, `security-auditor`, `technical-writer`.
