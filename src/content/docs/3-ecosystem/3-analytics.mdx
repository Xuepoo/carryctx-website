...
In v0.10.0 (since v0.8), `sync pull` validates the local-directory database fully before it replaces anything, and refuses a database belonging to a different project:
