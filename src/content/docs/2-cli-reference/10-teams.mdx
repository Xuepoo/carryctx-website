...
<Aside type="caution">
CarryCtx is the lifecycle management and persistence layer, not a process scheduler. Spawning processes, routing work, retries, concurrency limits, and model selection belong to the external harness. CarryCtx 0.9.0 does not claim a generic Automation Engine, Completion Gates, or lease/heartbeat runtime.
</Aside>
